...
int main()
{
	...
	std::cout << "true = " << I_True <<std::endl;
	std::cout << "nested = " << Simpson.Calculate_Integral(a, b, NumSegments, f_xsin) << std::endl;
	std::cout << "adaptive = " << Simpson.Calculate_Integral_Adaptive(a, b, NumSegments, 1, f_xsin) << std::endl;
